window.addEventListener('DOMContentLoaded', (event) => {
    ...
    selectedText.innerText = industryName.value;
      currentIndustry.push(industryName.value);
    // framework dd
    ...
    console.log(positioningSelected,[positioningName]);
    ...
    case "Homepage Headline":
     ...
     promptBase="Behave like an ecommerce expert and create a homepage headline for a"+ currentIndustry.pop() +"product called " + currentProduct.pop() +" from the brand "+ currentProduct.pop()+".";
