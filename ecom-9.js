window.addEventListener('DOMContentLoaded', (event) => {
    ...
    selectedText.innerText = industryName.value;
     let currentIndustry=industryName.value;
     if(industryName.value== "Select"){
     currentIndustry="";
     }
    // framework dd
    ...
    case "Homepage Headline":
     hideFields=[2,5,9];
     fieldInput();
     promptBase="Behave like an ecommerce expert and create a homepage headline for a"+ currentIndustry +"product called " + productValue+" from the brand "+ brandValue+".";
