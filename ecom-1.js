...
case "Homepage Headline":
 hideFields=[2,5,9];
 promptBase="Behave like an ecommerce expert and create a homepage headline for a [Industry] product called [product] from the brand [brand]";
 resultText.innerText=promptBase;
selectiveFields(hideFields);
console.log(basePromptMain);
break;
