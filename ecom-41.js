window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && fieldBrand.value.length > 2 && fieldProduct.value.length > 2 ){
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && fieldBrand.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && fieldProduct.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if( fieldProduct.value.length > 2 && fieldBrand.value.length > 2 && fieldIC.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && fieldBrand.value.length > 2 && fieldProduct.value.length > 2 && fieldIC.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let [industryName] = industrySelected;
        let channelSelect = [...channelNames].filter(e => e.checked);
    let [channelSelected] = channelSelect;
    if(industryName.value != "Select" && channelSelected.value != "Select" && fieldBrand.value.length > 2 && fieldProduct.value.length > 2 && fieldIC.value.length > 2 ){
     resultData.style.display="block";
     }
    }
