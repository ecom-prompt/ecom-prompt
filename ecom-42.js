window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && brandInput.value.length > 2 && productInput.value.length > 2 ){
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && brandInput.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && productInput.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if( productInput.value.length > 2 && brandInput.value.length > 2 && icInput.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let industrySelected = [...industryNames].filter(e => e.checked);
    let [industryName] = industrySelected;
    if(industryName.value != "Select" && brandInput.value.length > 2 && productInput.value.length > 2 && icInput.value.length > 2 ){
     resultData.style.display="block";
     }
    }
    ...
    let [industryName] = industrySelected;
        let channelSelect = [...channelNames].filter(e => e.checked);
    let [channelSelected] = channelSelect;
    if(industryName.value != "Select" && channelSelected.value != "Select" && brandInput.value.length > 2 && productInput.value.length > 2 && icInput.value.length > 2 ){
     resultData.style.display="block";
     }
    }
