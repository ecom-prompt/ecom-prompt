window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let resetBtnForm = document.querySelectorAll("#reset-form-btn");
    ...
    validationBtn.addEventListener("click",function(){
      ...
      setTimeout(function(){messageError.forEach(message=>message.style.display="none")},5000);
    })
    }
    // function validation
...
let industryValues= document.querySelectorAll(".industry-select");
[...industryValues].forEach((industry)=>{
industry.checked = false;
})
 let newIndustry= [...industryValues].find(e=>e.value=="Select");
    newIndustry.setAttribute("checked");
 let frameworkValues = document.querySelectorAll(".framework-select");
    [...frameworkValues].forEach((industry)=>{
industry.checked = false;
})
     let newFramework= [...frameworkValues].find(e=>e.value=="Select");
    newFramework.setAttribute("checked");
    
  let positioningValues = document.querySelectorAll(".positioning-select");
    [...positioningValues].forEach((industry)=>{
industry.checked = false;
})
     let newPositioning= [...positioningValues].find(e=>e.value=="Select");
    newPositioning.setAttribute("checked");
    
  let holidayValues = document.querySelectorAll(".holiday-select");
    [...holidayValues].forEach((industry)=>{
industry.checked = false;
})
     let newHoliday= [...holidayValues].find(e=>e.value=="Select");
   newHoliday.setAttribute("checked");
    
 let offerValues = document.querySelectorAll(".offer-select");
    [...offerValues].forEach((industry)=>{
industry.checked = false;
})
     let newOffer= [...offerValues].find(e=>e.value=="Select");
    newOffer.setAttribute("checked");
    
 let channelValues = document.querySelectorAll(".channel-select");
    [...channelValues].forEach((industry)=>{
industry.checked = false;
})
     let newChannel= [...channelValues].find(e=>e.value=="Select");
    newChannel.setAttribute("checked");
}
...
function resetFullForm() {
    ...
    //resetBtnForm.addEventListener("click",resetFullForm);
