...
function dropDownValues(fields){
    let arrayCurrent = [currentBrand,currentProduct,currentIC,currentComp,currentIndustry,currentFramework,currentPositioning,currentHoliday,currentOffer,currentChannel];
    for(let i=0;i<fields.length;i++){
    arrayCurrent[fields[i]].innerText="";
    }
}
