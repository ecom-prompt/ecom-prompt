window.addEventListener('DOMContentLoaded', (event) => {
    ...
    if(currentIndustry != "Select" && currentBrand.length > 2 && currentProduct.length > 2 ){
     resultData.style.display="block";
        ...
        else if(currentIndustry == "Select" || currentBrand.length < 2 || currentProduct.length < 2 ){
    ...
    if(currentIndustry != "Select" && currentBrand.length > 2 ){
     resultData.style.display="block";
         ...
         else if(currentIndustry == "Select" || currentBrand.length < 2){
        resultData.style.display="none";
        }
    }
   ...
   //  product and brand
    if(currentIndustry != "Select" && currentProduct.length > 2 ){
     resultData.style.display="block";
         ...
         else if(currentIndustry == "Select" || currentProduct.length < 2){
        resultData.style.display="none";
        }
    }
    ...
    if( productInput.value.length > 2 && currentBrand.length > 2 && currentIC.length > 2 ){
     resultData.style.display="block";
         ...
         else if(productInput.value.length < 2 || currentBrand.length < 2 || currentIC.length < 2){
        resultData.style.display="none";
        }
    }
    ...
    if(currentIndustry != "Select" && currentBrand.length > 2 && currentProduct.length > 2 && currentIC.length > 2 ){
     resultData.style.display="block";
         ...
         else if(currentIndustry == "Select" || currentBrand.length < 2 || currentProduct.length < 2 || currentIC.length < 2){
        resultData.style.display="none";
        }
    }
    ...
    if(currentIndustry != "Select" && currentChannel != "Select" && currentBrand.length > 2 && currentProduct.length > 2){
     resultData.style.display="block";
         ...
         else if(currentIndustry == "Select" || currentChannel == "Select" && currentBrand.length < 2 && currentProduct.length < 2){
        resultData.style.display="none";
        }
    }
...
copyBtn1.style.backgroundColor="#ff7608";
let copyWrapperText = document.querySelector(".result-text").innerText;
setTimeout(function(){copyBtn1.style.backgroundColor="#0000";copyBtn1.innerText="Copy";},1000)
...
copyBtn2.style.backgroundColor="#ffc71c";
let copyWrapperText = document.querySelector(".result-ai").innerText;
setTimeout(function(){copyBtn2.style.backgroundColor="#0000";copyBtn2.innerText="Copy";},1000)
navigator.clipboard.writeText(copyWrapperText);
});    
